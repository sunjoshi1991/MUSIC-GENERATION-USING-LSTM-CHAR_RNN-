...
## to run this type the cmd : sample.py --len 1024 100 , which is len of character sample and seed.
import argparse
import os
import json
...
from rnn_model import build_model, load_weights
...
### build model architecture LSTM with dropout and softmax activation at O/P layer.
...
## GENERATE SAMPLE TEXT (MUSICAL NOTE)
